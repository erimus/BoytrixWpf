...
namespace Boytrix.Logic.DataAccess.DbUpdate.UpdateServiceReference {
    ...
    public interface IUpdateService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUpdateService/GetWithSpGet", ReplyAction="http://tempuri.org/IUpdateService/GetWithSpGetResponse")]
        string GetWithSpGet(string className, string sqlStatements);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUpdateService/GetWithSpGet", ReplyAction="http://tempuri.org/IUpdateService/GetWithSpGetResponse")]
        System.Threading.Tasks.Task<string> GetWithSpGetAsync(string className, string sqlStatements);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IUpdateServiceChannel : Boytrix.Logic.DataAccess.DbUpdate.UpdateServiceReference.IUpdateService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UpdateServiceClient : System.ServiceModel.ClientBase<Boytrix.Logic.DataAccess.DbUpdate.UpdateServiceReference.IUpdateService>, Boytrix.Logic.DataAccess.DbUpdate.UpdateServiceReference.IUpdateService {
        ...
        public string GetWithSpGet(string className, string sqlStatements) {
            return base.Channel.GetWithSpGet(className, sqlStatements);
        }
        
        public System.Threading.Tasks.Task<string> GetWithSpGetAsync(string className, string sqlStatements) {
            return base.Channel.GetWithSpGetAsync(className, sqlStatements);
        }

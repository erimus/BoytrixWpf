...
{
   public class ShowProductViewCommand : ICommand
    {
       private ProductTaskButtonViewModel m_ViewModel;
       public ShowProductViewCommand(ProductTaskButtonViewModel viewModel)
       {
       ...
       public void Execute(object parameter)
       {
           ...
           // Show Ribbon Tab
           var ProductRibbonTab = new Uri("ProductRibbonTab", UriKind.Relative);
           regionManager.RequestNavigate("RibbonRegion", ProductRibbonTab);

           // Show Navigator
           var ProductNavigator = new Uri("ProductNavigator", UriKind.Relative);
           ...
           //// Show Workspace
           //var ProductWorkspace = new Uri("ProductWorkspace", UriKind.Relative);
       ...
       private void NavigationCompleted(NavigationResult result)
       {
           ...
           navigationCompletedEvent.Publish("Product");
       }

...
{
   public class PurchasingTaskButtonViewModel : BindableBase, INavigationAware
    {
        #region Fields
        ...
        /// Default constructor.
        /// </summary>
        public PurchasingTaskButtonViewModel()
        {
            this.Initialize();
        }
              #endregion
        ...
        /// </summary>
        public ICommand ShowPurchasingView { get; set; }   

        #endregion

        #region Purchasing Properties
        ...
        private void OnNavigationCompleted(string publisher)
        {
            ...
            if (publisher == "Purchasing") return;
        ...
        private void Initialize()
        {
            ...
            this.ShowPurchasingView = new ShowPurchasingViewCommand(this);

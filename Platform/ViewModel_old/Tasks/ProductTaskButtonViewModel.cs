...
{
    public class ProductTaskButtonViewModel : BindableBase, INavigationAware
    {
        #region Fields
        ...
        #endregion
        public ProductTaskButtonViewModel()
        {
            this.Initialize();
        }
        ...
        /// </summary>
        public ICommand ShowProductView { get; set; }
        ...
        private void Initialize()
        {
            ...
            this.ShowProductView = new ShowProductViewCommand(this);

...
{
    public class AdminTaskButtonViewModel : BindableBase, INavigationAware
    {
          #region Fields
        ...
        /// Default constructor.
        /// </summary>
        public AdminTaskButtonViewModel()
        {
            this.Initialize();
        }
        ...
        /// </summary>
        public ICommand ShowAdminView { get; set; }   
        ...
        private void Initialize()
        {
            ...
            this.ShowAdminView = new ShowAdminViewCommand(this);

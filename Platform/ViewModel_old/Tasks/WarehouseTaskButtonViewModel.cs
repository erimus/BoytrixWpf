...
{
    public class WarehouseTaskButtonViewModel : BindableBase, INavigationAware
    {
        #region Fields
        ...
        #endregion
        public WarehouseTaskButtonViewModel()
        {
            this.Initialize();
        }
        ...
        /// </summary>
        public ICommand ShowWarehouseView { get; set; }
        ...
        private void Initialize()
        {
            ...
            this.ShowWarehouseView = new ShowWarehouseViewCommand(this);

...
//namespace Boytrix.UI.WPF.BoytrixModules.Admin.Commands
//{
//    public class ShowAdminViewCommand:ICommand
//    {
//        private AdminViewModel m_ViewModel;
//        public ShowAdminViewCommand(AdminViewModel viewModel)
//        {
...
//            // Show Ribbon Tab
//            var AdminRibbonTab = new Uri("AdminRibbonTab", UriKind.Relative);
//            regionManager.RequestNavigate("RibbonRegion", AdminRibbonTab);

//            // Show Navigator
//            var AdminNavigator = new Uri("AdminNavigator", UriKind.Relative);
...
//            // Show Workspace
//            var AdminWorkspace = new Uri("AdminWorkspace", UriKind.Relative);
...
//            navigationCompletedEvent.Publish("Admin");
//        }
